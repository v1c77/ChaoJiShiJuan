...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table id="addtable">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox  class="form-control"   ID="txtA" runat="server" TextMode="MultiLine" Rows="2" Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox  class="form-control"   ID="txtB" runat="server" TextMode="MultiLine" Rows="2" Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox  class="form-control"   ID="txtC" runat="server" TextMode="MultiLine" Rows="2" Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox  class="form-control"   ID="txtD" runat="server" TextMode="MultiLine" Rows="2" Width="300px"></asp:TextBox>
